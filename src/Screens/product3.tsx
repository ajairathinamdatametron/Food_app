...
const product3 = ({ navigation }: any) => {
    const [spicy, setSpicy] = useState(50);
  const [portion, setPortion] = useState(1);
  const finalCost = portion * 58;
  const cartItems = [
  {
    name: "Chicken Burger",
    qty: portion,
  ...
  />
      ...
      style={styles.burger}
        />
        <View>
            <Text style={styles.tittle}>Hamburger Chicken Burger</Text>
                  <Text style={styles.ratingtext}>⭐ 4.8 - 14 mins</Text>
                  <Text style={styles.paragraph}>Our chicken burger is a delicious and healthier alternative to traditional beef burgers, perfect for those looking for a lighter meal option. Try it today and experience the mouth-watering flavors of our Hamburger Chicken Burger!</Text>
        </View>
...
<View style={styles.bottomRow}>
   ...
   <Text style={styles.cost}>$ {portion*58}
    </Text>
