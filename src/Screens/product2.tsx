...
const product2 = ({ navigation }: any) => {
    const [spicy, setSpicy] = useState(50);
  const [portion, setPortion] = useState(1);
  const finalCost = portion * 38;
  const cartItems = [
  {
    name: "Veggie Burger",
    qty: portion,
  ...
  />
      ...
      style={styles.burger}
        />
        <View>
            <Text style={styles.tittle}>Hamburger Veggie Burger</Text>
                  <Text style={styles.ratingtext}>⭐ 4.8 - 14 mins</Text>
                  <Text style={styles.paragraph}>Enjoy our delicious Hamburger Veggie Burger, made with a savory blend of fresh vegetables and herbs, topped with crisp lettuce, juicy tomatoes, and tangy pickles, all served on a soft, toasted bun. </Text>
        </View>
...
<View style={styles.bottomRow}>
   ...
   <Text style={styles.cost}>$ {portion*38}
    </Text>
