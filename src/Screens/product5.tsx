...
const product5 = ({ navigation }: any) => {
    const [spicy, setSpicy] = useState(50);
  const [portion, setPortion] = useState(1);
  const finalCost = portion * 80;
  const cartItems = [
  {
    name: "veg pizza",
    qty: portion,
  ...
  />
      ...
      style={styles.burger}
        />
        <View>
            <Text style={styles.tittle}>Veg Pizza</Text>
                  <Text style={styles.ratingtext}>⭐ 5.7 - 15 mins</Text>
                  <Text style={styles.paragraph}>Indulge in our crispy and savory Veg Pizza, made with a delicious vegetable filling, hand-tossed and baked to perfection, served on a crispy crust with a variety of toppings.</Text>
        </View>
...
<View style={styles.bottomRow}>
   ...
   <Text style={styles.cost}>$ {portion*80}
    </Text>
