...
const product1 = ({ navigation }: any) => {
    const [spicy, setSpicy] = useState(50);
  const [portion, setPortion] = useState(1);
  const finalCost = portion * 54;
  const cartItems = [
  {
    name: "Cheeseburger",
    qty: portion,
  ...
  />
      ...
      style={styles.burger}
        />
        <View>
            <Text style={styles.tittle}>Cheeseburger Wendy's Burger</Text>
                  <Text style={styles.ratingtext}>⭐ 4.5 - 26 mins</Text>
                  <Text style={styles.paragraph}>The Cheeseburger Wendy's Burger is a classic fast food burger that packs a punch of flavor in every bite. Made with a juicy beef patty cooked to perfection, it's topped with melted American cheese, crispy lettuce, ripe tomato, and crunchy pickles.</Text>
        </View>
...
<View style={styles.bottomRow}>
   ...
   <Text style={styles.cost}>$ {portion*54}
    </Text>
