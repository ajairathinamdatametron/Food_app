...
const product6 = ({ navigation }: any) => {
    const [spicy, setSpicy] = useState(50);
  const [portion, setPortion] = useState(1);
  const finalCost = portion * 150;
  const cartItems = [
  {
    name: "Chicken Pizza",
    qty: portion,
  ...
  />
      ...
      style={styles.burger}
        />
        <View>
            <Text style={styles.tittle}>Chicken Pizza</Text>
                  <Text style={styles.ratingtext}>⭐ 7.7 - 15 mins</Text>
                  <Text style={styles.paragraph}>Indulge in our crispy and savory Chicken Pizza, made with a delicious chicken filling, hand-tossed and baked to perfection, served on a crispy crust with a variety of toppings.</Text>
        </View>
...
<View style={styles.bottomRow}>
   ...
   <Text style={styles.cost}>$ {portion*150}
    </Text>
